...
{
    numb: 3,
    question: "¿Cuál de los siguientes sistemas de ficheros NO es recomendable usar con WS 19?",
    answer: "FAT32.",
    options: [
        "Todos son válidos.",
        "REFS.",
...
},
{
    numb: 4,
    question: "¿Cuál es el objetivo de la edición Datacenter de WS 2019?",
    answer: "Para centros de datos y procesamiento en la nube con alto nivel de virtualización.",
    options: [
        "Para pequeñas empresas, de menor coste y prestaciones más limitadas.",
        "Para clientes básicos de una red.",
        "Para centros de datos y procesamiento en la nube con alto nivel de virtualización.",
...
{
    numb: 6,
    question: "¿Es recomendable configurar una IP fija en el servidor? Elige la respuesta más correcta.",
    answer: "Sí, para que no cambie con cada arranque.",
    options: [
        "Sí, para que el router nos proporcione salida a internet sin problemas.",
        "Ninguna respuesta es correcta.",
...
{
    numb: 7,
    question: "Escribe el número de TB máximos de memoria que permite la edición Datacenter de WS 2019.",
    answer: "24",
    options: [
        "16",
        "20",
...
{
    numb: 8,
    question: "¿Cuál es la equivalencia de versión de escritorio tiene WS 2019?",
    answer: "Windows 10.",
    options: [
        "Windows 8.",
        "Windows 10.",
...
{
    numb: 11,
    question: "¿A qué categoría debemos acceder si hay cambiar el formato de fecha/hora porque nos cambiamos de país?",
    answer: "Región.",
    options: [
        "Estimación horaria.",
        "Ninguna respuesta es correcta.",
...
{
    numb: 12,
    question: "¿Qué rol no admite la edición Standard respecto a la Datacenter en WS 2019?",
    answer: "Controladora de Red.",
    options: [
        "Servicios web (IIS).",
        "Hyper-V.",
...
},
{
    numb: 13,
    question: "¿Qué limitación tiene la edición Essentials de WS 2019?",
    answer: "Máximo de 25 usuarios y/o 50 dispositivos, y 2 procesadores. No permite virtualización.",
    options: [
        "La licencia se basa en núcleos de servidor, admite un máximo de 2 MV, y necesita CAL.",
        "Máximo de 25 usuarios y/o 50 dispositivos, y 2 procesadores. No permite virtualización.",
        "Máximo de 50 usuarios y 2 MV.",
...
{
    numb: 14,
    question: "¿Es posible pasar de una versión de evaluación a una edición oficial?",
    answer: "True.",
    options: [
        "True.",
        "False."
...
{
    numb: 15,
    question: "¿Cuál es la última versión de Windows Server que ha salido al mercado?",
    answer: "Windows Server 2022.",
    options: [
        "Windows Server 2020.",
        "Windows Server 2022.",
...
{
    numb: 17,
    question: "¿Qué diferencias suelen haber entre las diferentes ediciones de cada versión de Windows Server?",
    answer: "Se empaquetan con diferentes herramientas y capacidades.",
    options: [
        "Se empaquetan con diferentes herramientas y capacidades.",
        "El tamaño de la BBDD de Active Directory.",
...
{
    numb: 22,
    question: "¿Es posible pasar de una versión gráfica a una de texto en WS 2019?",
    answer: "No.",
    options: [
        "No.",
        "Sí, pero únicamente en el caso de la edición Standard.",
...
{
    numb: 23,
    question: "¿Qué significan las siglas WAC?",
    answer: "Windows Admin Center.",
    options: [
        "Windows Admin Console.",
        "Windows Access Console.",
        "Windows Admin Center.",
        "Windows Access Center."
    ]
},
{
    numb: 24,
    question: "Siglas de la herramienta de manejo de agrupación consolas:",
    answer: "WSUS.",
    options: [
        "WMS.",
        "WSUS.",
...
{
    numb: 25,
    question: "La memoria máxima soportada por Windows Server 2019 es:",
    answer: "24 TB.",
    options: [
        "32 TB.",
        "16 TB.",
